#!/usr/bin/python3
"""
Flask application that serves the 4-hbnb page with state, city, and amenity filters.
"""
...
def hbnb_filters():
    """
    Renders the 4-hbnb.html template with states, amenities, and places.
    """
    ...
    # Render the 4-hbnb.html template with the context
